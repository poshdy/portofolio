  ...
  return (
    <div className="flex flex-col items-center justify-center gap-3 lg:items-start lg:justify-start w-full lg:w-[30%] py-2 lg:py-4">
      <p className="text-secondary text-xs lg:text-sm  text-center lg:text-left   ">
        Hey 👋 My name is Roshdy and I’m a self-taught Front-end developer with
        ...
        <br />
        <br />
        I’m a dedicated and hardworking person that will not only develop and
        ...
        clone
        <br />
        I’m currently digging into backend development to build a powerful AI
        SaaS platform. If you’re looking to build your own website in a modern
